...
def train_alexnet(model_name, filename, optimizer_name, criterion_name, scheduler_name, learning_rate, isEarlyStopping): 
    ...
    # Defining optimizer
    optimizer_helper = OptimizerHelper(model = alexnet_model, optimizer_name = optimizer_name, learning_rate = learning_rate)
...
if __name__ == '__main__':
    train_alexnet(model_name = "Alexnet_Model", filename = "Alexnet", optimizer_name = "Adam", scheduler_name = "Reduce LR on Plateau", criterion_name = "Cross Entropy Loss Weighted", learning_rate = 0.001, isEarlyStopping = False)