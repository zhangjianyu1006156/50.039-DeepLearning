...
def train_vgg(model_name, filename, optimizer_name, criterion_name, scheduler_name, learning_rate, isEarlyStopping): 
    ...
    # Defining optimizer
    optimizer_helper = OptimizerHelper(model = vgg_model, optimizer_name = optimizer_name, learning_rate = learning_rate)
...
if __name__ == '__main__':
    train_vgg(model_name = "VGG_Model", filename = "VGG_NoES", optimizer_name = "Adam", scheduler_name = "Reduce LR on Plateau", criterion_name = "Cross Entropy Loss Weighted", learning_rate = 0.001, isEarlyStopping = False)