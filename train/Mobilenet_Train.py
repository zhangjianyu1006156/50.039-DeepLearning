...
def train_mobilenet(model_name, filename, optimizer_name, criterion_name, scheduler_name, learning_rate, isEarlyStopping): 
    ...
    mobilenet_model = models.mobilenet_v3_large(weights='MobileNet_V3_Large_Weights.DEFAULT')
    ...
    # Defining optimizer
    optimizer_helper = OptimizerHelper(model = mobilenet_model, optimizer_name = optimizer_name, learning_rate = learning_rate)
...
if __name__ == '__main__':
    train_mobilenet(model_name = "MobileNet_Model", filename = "MobileNet", optimizer_name = "Adam", scheduler_name = "Reduce LR on Plateau", criterion_name = "Cross Entropy Loss Weighted", learning_rate = 0.001, isEarlyStopping = False)